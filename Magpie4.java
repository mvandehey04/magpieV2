...
public class Magpie4
{
    ...
    public String getResponse(String statement)
    {
        ...
        else if(findKeyword(statement, "I", 0) >= 0 && statement.contains("you")){
    ...
    private String transformIYouStatement(String statement){
        ...
        String restOfStatement = statement.substring(position + 2).trim();
     ...
     */
     ...
     // Modify the getRandomResponse method to use an array to manage the random responses. 
     // Revise the method to return one of the responses in the array.
     // Add two noncommittal responses to the array.
    ...
    private String getRandomResponse()
    {
        ...
        responses[4] = "That's so cool!";
        responses[5] = "I'm invested ... tell me more!";
